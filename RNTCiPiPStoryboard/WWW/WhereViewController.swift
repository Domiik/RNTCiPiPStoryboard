...
//         }
         ...
         override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
           ...
           if segue.identifier == "Card" {
               if let vc = segue.destination as? CalculationOfResultsWWW {
       ...
       extension WhereViewController: UICollectionViewDelegate, UICollectionViewDataSource {
         
         func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
           return ModelWWW.instance.nameWhereCards.count
         }
         ...
         func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
           ...
           cell.nameW.text = ModelWWW.instance.nameWhereCards[indexPath.item].description
             ...
             dictionarySelectedIndecPath[indexPath] = true
               var cell = collectionView.cellForItem(at: indexPath)
                   if cell?.isSelected == true {
                        ...
                        ModelWWW.instance.whereArray.append(item + 1)
       ...
       extension WhereViewController: CustomLayoutDelegate {
